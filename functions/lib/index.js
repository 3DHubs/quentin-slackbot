...
// });
exports.search = functions.https.onRequest((_request, _response) => {
...
exports.newTopic = functions.https.onRequest((_request, _response) => {
    _response.sendStatus(200); // respond to Slack that we have received the request
    if (_request.body.topic.views > 0)
        return;
...
exports.newTopicEngineering = functions.https.onRequest((_request, _response) => {
    _response.sendStatus(200); // respond to Slack that we have received the request
    if (_request.body.topic.views > 0)
        return;
    console.log(_request.body);
